    ...
    <div className="flex min-h-screen flex-col items-center justify-center bg-hive-bg bg-hex-grid p-4">
      ...
      >
        <div className="flex flex-col items-center gap-2 text-center">
          ...
          <p className="font-mono text-xs text-hive-subtle">Create your account</p>
        </div>
        ...
        <p className="text-center font-mono text-[11px] text-hive-subtle">
          Already have an account?{' '}
          <Link href="/login" className="text-honey-400 hover:underline">Sign in</Link>
        </p>
      </form>
    </div>
  );
